...
public class CommandManager {
    ...
    public CommandManager(CommandDispatcher<CommandSourceStack> dispatcher, PlanForge plugin, ErrorLogger errorLogger) {
    ...
    private LiteralArgumentBuilder<CommandSourceStack> buildCommand(Subcommand subcommand, String alias) {
        RequiredArgumentBuilder<CommandSourceStack, String> arguments = RequiredArgumentBuilder.argument("arguments", StringArgumentType.greedyString());
        arguments.suggests((context, builder) -> arguments(subcommand, context, builder));
        arguments.executes(ctx -> execute(ctx, subcommand));
        LiteralArgumentBuilder<CommandSourceStack> literal = LiteralArgumentBuilder.literal(alias);
